...
CREATE TABLE pracownik(
    ...
    imie NOT NULL varchar(255),
    nazwisko NOT NULL varchar(255),
    pesel char(11),
...
CREATE TABLE naprawa(
    ...
    data_przyjecia DATE,
    opis usterki varchar(255) NOT NULL CHECK(length(opis_usterki>10)),
    zaliczka int CHECK(opis_usterki BETWEEN 100 AND 1000)
);
